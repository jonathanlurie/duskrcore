(function (global, factory) {
            ...
            (global = global || self, global.duskrcore = factory());
            ...
            function addField(type, value) {
              ...
              if (options.compact) {
                if (
                  ...
                  (isArray$3(options.alwaysArray) ? options.alwaysArray.indexOf(options[type + 'Key']) !== -1 : options.alwaysArray)
                ) {
                  currentElement[options[type + 'Key']] = [];
                }
                if (currentElement[options[type + 'Key']] && !isArray$3(currentElement[options[type + 'Key']])) {
                ...
                if (isArray$3(currentElement[options[type + 'Key']])) {
            ...
            function onStartElement(name, attributes) {
              ...
              if (options.compact) {
                ...
                if (
                  ...
                  (isArray$3(options.alwaysArray) ? options.alwaysArray.indexOf(name) !== -1 : options.alwaysArray)
                ) {
                  currentElement[name] = [];
                }
                if (currentElement[name] && !isArray$3(currentElement[name])) {
                  currentElement[name] = [currentElement[name]];
                }
                if (isArray$3(currentElement[name])) {
            ...
            function writeElementsCompact(element, options, depth, firstLine) {
              ...
              for (key in element) {
                if (element.hasOwnProperty(key)) {
                  nodes = isArray$4(element[key]) ? element[key] : [element[key]];
            ...
            class AdobeXmp {
              ...
              setXmlPayload(xmlStr){
                ...
                let jsonPayload = lib.xml2json(xmlStr, {compact: true});
                this._objectRepresentation = JSON.parse(jsonPayload);
              }


              getXml(){
                return lib.json2xml(JSON.stringify(this._objectRepresentation), {compact: true, ignoreComment: true, spaces: 4})
              }
